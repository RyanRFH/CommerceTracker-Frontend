    ...
    return (
        <div className=''>
            ...
            <div className='flex flex-col sm:flex-row w-full justify-evenly text-3xl lg:text-6xl min-h-[500px] md:min-h-[300px]'>
                ...
                <div className='flex justify-center items-center'>
                    <a href='/products' className='w-full h-full flex justify-center items-center'>
                        <img className='mt-[10px] max-w-[300px] lg:max-w-[400px] rounded-xl absolute z-[-50]' src='https://queue-it.com/media/ppcp1twv/product-drop.jpg' alt='products' />
                        <p className=' text-white font-bold bg-green-400 rounded-md px-[20px] py-[5px]'>Products</p>
                    </a>
                </div>

                <div className='flex justify-center items-center'>
                    <a href='/orders' className='w-full h-full flex justify-center items-center'>
                        <img className='mt-[10px] max-w-[300px] lg:max-w-[400px] rounded-xl absolute z-[-50]' src='https://cdn-ikppnan.nitrocdn.com/zaXtQkXNMlZQivMrhELgMpbOEjTHUDcT/assets/images/optimized/rev-c790198/www.locate2u.com/wp-content/uploads/elementor/thumbs/A-1-47-qmwyerlvt0ntofi3fg220f0adfvckpe5xgtubb4uyy.webp' alt='orders' />
                        <p className='text-white font-bold bg-blue-400 rounded-md px-[20px] py-[5px]'>Orders</p>
                    </a>
                </div>
            ...
            <div className='flex justify-center'>
                <div className='flex flex-col w-3/4 mt-[30px] bg-white px-[20px] py-[10px] rounded-2xl shadow-2xl'>
